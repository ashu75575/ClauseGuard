...
interface ShapeGridProps {
  ...
  /** Outer vignette color. Use a near-transparent color to disable. */
...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      if (
        ...
        if (hoveredSquareRef.current) pushTrail(hoveredSquareRef.current);
  ...
  return (
    <canvas ref={canvasRef} className={`block h-full w-full border-none ${className}`.trim()} />
  );
};
