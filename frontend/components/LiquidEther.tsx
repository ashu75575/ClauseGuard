...
/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars -- Upstream React Bits WebGL internals use heterogeneous shader-pass payloads. */
